                ...
                <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-lg text-[var(--slate-400)] leading-relaxed">
                            <p>
                                I'm a Computer Science student with a passion for <span className="text-[var(--cyan-400)]">building</span> and <span className="text-[var(--purple-400)]">breaking</span> things.
                            </p>
                            <p>
                            ...
                            <p>
                                When I'm away from the keyboard, I'm usually tinkering with hardware. You'll find me messing with <span className="text-[var(--cyan-400)]">Arduinos</span>, wiring up sensors, or taking apart laptops to see how they tick. I'm a builder at heart, exploring <span className="text-[var(--purple-400)]">security</span> and tech one project at a time.
                            </p>
                        </div>
                    </motion.div>
                </div>
